                    ...
                    <div class="card">
                        ...
                        <img src="" 
                            ...
                            <div class="d-flex justify-content-between align-items-end mt-4">
                                <div>
                                    <h5 class="mb-3 text-truncate"> {{product.name}} </h5>
                                    <h5 class="my-0"> ${{product.price}}
                                    </h5>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/promvuthy/Desktop/Movies/Admin/resources/views/ecommerce-products.blade.php ENDPATH**/ ?>